...
public final class UnsignedKt {
    ...
    public static final long m580ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m401constructorimpl(Long.compareUnsigned(v1, v2) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
        ...
        return ULong.m401constructorimpl((Long.compareUnsigned(ULong.m401constructorimpl(rem), ULong.m401constructorimpl(v2)) < 0 ? 0 : 1) + quotient);
    }
    ...
    public static final long m581ulongRemaindereb3DHEI(long v1, long v2) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (Long.compareUnsigned(ULong.m401constructorimpl(rem), ULong.m401constructorimpl(v2)) >= 0) {
            j = v2;
        }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return v <= 2.147483647E9d ? UInt.m322constructorimpl((int) v) : UInt.m322constructorimpl(UInt.m322constructorimpl((int) (v - Integer.MAX_VALUE)) + UInt.m322constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        return v < 9.223372036854776E18d ? ULong.m401constructorimpl((long) v) : ULong.m401constructorimpl(ULong.m401constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
