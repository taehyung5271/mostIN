...
public class GoogleSignatureVerifier {
    ...
    public boolean isPackageGoogleSigned(@Nullable String callingPackage) throws PackageManager.NameNotFoundException {
        zzx zzxVarZzc = zzc(callingPackage, false, false);
        zzxVarZzc.zze();
        return zzxVarZzc.zza;
    }

    public boolean isUidGoogleSigned(int uid) throws PackageManager.NameNotFoundException {
        zzx zzxVarZzc;
        int length;
