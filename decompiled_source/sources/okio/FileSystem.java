...
public abstract class FileSystem {
    ...
    public final <T> T m1982read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws Throwable {
        Intrinsics.checkNotNullParameter(file, "file");
    ...
    public static /* synthetic */ Object m1981write$default(FileSystem fileSystem, Path file, boolean mustCreate, Function1 writerAction, int i, Object obj) throws Throwable {
        if (obj == null) {
            if ((i & 2) != 0) {
                mustCreate = false;
            }
    ...
    public final <T> T m1983write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws Throwable {
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
