...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM227constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM227constructorimpl = Result.m227constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM227constructorimpl = Result.m227constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m230exceptionOrNullimpl(objM227constructorimpl) == null) {
            obj2 = objM227constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM227constructorimpl2 = Result.m227constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM227constructorimpl2 = Result.m227constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m230exceptionOrNullimpl(objM227constructorimpl2) == null) {
            obj = objM227constructorimpl2;
        }
