...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object mo1735trySendJP2dKIU(E element) {
        Object result = offerInternal(element);
        if (result == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.INSTANCE.m1755successJP2dKIU(Unit.INSTANCE);
        }
        if (result == AbstractChannelKt.OFFER_FAILED) {
            Closed closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m1754failurePtdJZtk() : ChannelResult.INSTANCE.m1753closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (result instanceof Closed) {
            return ChannelResult.INSTANCE.m1753closedJP2dKIU(helpCloseAndGetSendException((Closed) result));
        }
    ...
    */
    public final java.lang.Object sendSuspend(E r12, kotlin.coroutines.Continuation<? super kotlin.Unit> r13) {
        ...
        L6f:
            ...
            java.lang.Object r8 = kotlin.Result.m227constructorimpl(r8)
            r7.resumeWith(r8)
            goto L99
        L87:
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m227constructorimpl(ResultKt.createFailure(it)));
        } else {
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m227constructorimpl(ResultKt.createFailure(sendException)));
        }
    }
    ...
    */
    ...
    private final void helpClose(Closed<?> closed) {
        Object closedList = InlineList.m1771constructorimpl$default(null, 1, null);
        while (true) {
            LockFreeLinkedListNode prevNode = closed.getPrevNode();
            Receive previous = prevNode instanceof Receive ? (Receive) prevNode : null;
            if (previous == null) {
                break;
            } else if (!previous.mo1779remove()) {
                previous.helpRemove();
            } else {
                closedList = InlineList.m1776plusFjFbRPM(closedList, previous);
            }
        }
        if (closedList != null) {
