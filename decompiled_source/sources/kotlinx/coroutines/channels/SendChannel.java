...
public interface SendChannel<E> {
    ...
    Object mo1735trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1735trySendJP2dKIU(e);
            if (ChannelResult.m1750isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1744exceptionOrNullimpl = ChannelResult.m1744exceptionOrNullimpl(result);
