...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM227constructorimpl = Result.m227constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM227constructorimpl = Result.m227constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m233isFailureimpl(objM227constructorimpl) ? null : objM227constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1757installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1757installSignalHandler$lambda1(Signal it) {
