...
public class ProfileInstaller {
    ...
    public static void writeProfile(Context context, Executor executor, DiagnosticsCallback diagnostics) throws PackageManager.NameNotFoundException {
        writeProfile(context, executor, diagnostics, false);
    }

    static void writeProfile(Context context, Executor executor, DiagnosticsCallback diagnostics, boolean forceWriteProfile) throws PackageManager.NameNotFoundException {
